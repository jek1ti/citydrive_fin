...
const (
	TelemetryService_PutTelemetry_FullMethodName = "/telemetry.TelemetryService/PutTelemetry"
)
...
type TelemetryServiceClient interface {
	PutTelemetry(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutResponse, error)
}
...
func (c *telemetryServiceClient) PutTelemetry(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PutResponse)
	err := c.cc.Invoke(ctx, TelemetryService_PutTelemetry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TelemetryServiceServer interface {
	PutTelemetry(context.Context, *PutRequest) (*PutResponse, error)
...
func (UnimplementedTelemetryServiceServer) PutTelemetry(context.Context, *PutRequest) (*PutResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PutTelemetry not implemented")
}
...
func _TelemetryService_PutTelemetry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PutRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TelemetryServiceServer).PutTelemetry(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TelemetryService_PutTelemetry_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TelemetryServiceServer).PutTelemetry(ctx, req.(*PutRequest))
	}
...
var TelemetryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PutTelemetry",
			Handler:    _TelemetryService_PutTelemetry_Handler,
		},
	},
